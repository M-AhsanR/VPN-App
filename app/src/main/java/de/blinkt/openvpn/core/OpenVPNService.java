...
import com.watchmyapps.freevpn.BuildConfig;


import com.watchmyapps.freevpn.R;
import com.watchmyapps.freevpn.ui.activities.ServerActivity;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener {
    ...
    private void showNotification(final String msg, String tickerText, boolean lowpriority, long when, ConnectionStatus status) {
        int notifyID = 1;
        String CHANNEL_ID = "notif_channel_01";// The id of the channel.
        CharSequence name = "SmartVPN_Notification";// The user-visible name of the channel.
